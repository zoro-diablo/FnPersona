...
const TaxTable = () => {
    ...
    const data = {
        ...
        'Taxable Income': [{ label: '', new: 0, old: 0, oldDeduction: 0 }],
        'Tax due on above': [
    ...
    return (
        <div className='max-w-7xl mx-auto shadow-md'>
            <TableContainer component={Paper} style={{background: 'linear-gradient(45deg, #8c8c8c 30%, #f7f7f7 90%)',}}>
                ...
                <Table aria-label='simple table'>
                    <TableHead>
                        <TableRow>
                            <TableCell></TableCell>
                            <TableCell style={{ textAlign: 'center', borderLeft: '1px solid gray', fontSize: '16px' }} rowSpan={3}>Source</TableCell>
                            <TableCell></TableCell>
                            <TableCell></TableCell>
                            <TableCell></TableCell>
                        </TableRow>
                        ...
                        {rows.map((row) => (
                            <TableRow key={row.one}>
                                <TableCell
                                    component='th'
                                    scope='row'
                                    style={{ textAlign: 'center', borderRight: '1px solid gray', fontSize: '16px' }}
                                >
                                    {row.one}
                                </TableCell>
                                <TableCell style={{ textAlign: 'center', fontSize: '16px' }} align='right'>
                                    {row.two}
                                </TableCell>
                                <TableCell style={{ textAlign: 'center', fontSize: '16px' }} align='right'>
                                    {row.three}
